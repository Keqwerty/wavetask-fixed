...
KCMUtils.SimpleKCM {
    ...
    // Ajustes específicos del skin "macOS Dock".
    ...
    property alias cfg_tahoeFrameOffset: tahoeOffsetSlider.value
    ...
    Kirigami.FormLayout {
        ...
        // --- Ajustes del skin "macOS Dock" (sólo visibles con ese skin) ---
        QQC2.Label {
            Kirigami.FormData.isSection: true
            visible: root.cfg_skinName === "macOS Dock"
            text: "macOS Dock"
        }
        ...
        RowLayout {
            Kirigami.FormData.label: "Frame offset:"
            visible: root.cfg_skinName === "macOS Dock"
            spacing: Kirigami.Units.smallSpacing

            QQC2.Slider {
                id: tahoeOffsetSlider
                Layout.fillWidth: true
                from: -6
                to: 6
                stepSize: 0.1
            ...
            QQC2.Label {
                text: tahoeOffsetSlider.value.toFixed(1) + " px"
            }
        }
